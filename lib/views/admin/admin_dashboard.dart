...
// Ensure these imports point to the correct files where these classes are defined
...
class _AdminDashboardState extends State<AdminDashboard> {
  ...
  Widget build(BuildContext context) {
    ...
    // The list itself is final, but the widgets inside might not be const constructors.
